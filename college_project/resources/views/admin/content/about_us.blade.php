                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-9 mt-1">
                                <textarea name="return_policy" class="form-control" id="editor1" cols="30" rows="5">
                            ...
                            <div class="col-md-9 mt-1">
                                <textarea name="delivery_policy" class="form-control" id="editor2" cols="30" rows="5">
                                    {!! $company->delivery_policy !!}
                                </textarea>
                            </div>
                        </div>
                    </div>
