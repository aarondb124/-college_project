...
@section('title', 'What Happing')
@section('admin-content')
<main class="mb-5">
   <div class="container ">
    <div class="heading-title p-2 my-2">
        <span class="my-3 heading "><i class="fas fa-home"></i> <a class="" href="">Home</a> > Add What Happing</span>
    </div>
       <div class="row">
           <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="table-head"><i class="fas fa-cogs me-1"></i>What Happing</div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <label for="description"> Youtube Video <span class="text-danger">*</span> </label>
             ...
             <div class="col-12">
               <div class="card"> 
                <div class="card-header">
                    <div class="table-head"><i class="fas fa-table me-1"></i>What Happing List</div>
                </div>
                <div class="card-body table-card-body p-3">
