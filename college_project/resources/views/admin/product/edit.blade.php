                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="purchage" id="purchage"
                                                value="{{optional($product->inventory)->purchage }}"
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group input-group-sm">
                                                <select name="recording_mode_id" id="recording_mode_id"
                                                    class="custom-select form-control my-select my-form-control @error('recording_mode_id') is-invalid @enderror"
                                                    data-live-search="true">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group input-group-sm">
                                                <select name="effective_pixel_id" id="effective_pixel_id"
                                                    class="custom-select form-control my-select my-form-control @error('effective_pixel_id') is-invalid @enderror"
                                                    data-live-search="true">
                                        ...
                                        <div class="col-md-8 mt-1">
                                            <div class="input-group input-group-sm">
                                                <select name="sub_category_id" id="sub_category_id"
                                                    ...
                                                    data-live-search="true">
                                                    <option data-tokens="ketchup mustard" value=""> Sub Category</option>
                                        ...
                                        <div class="col-md-8 mt-1">
                                            <div class="input-group input-group-sm">
                                                <select name="subsubcategory_id" id="subsubcategory_id"
                                                    ...
                                                    data-live-search="true">
                                                    <option data-tokens="ketchup mustard" value="">Sub Subcategory</option>
                                                    @foreach($subsubcategory as $item)
                                                    <option  value="{{ $item->id }}" {{ $product->subsubcategory_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="input-group-append">
                                                    <a class="border rounded my-select my-form-control py-0 px-2"
