...
@section('title', 'Edit Camera Format')
   ...
   <div class="container ">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body table-card-body p-3 mytable-body">
            <form action="{{ route('camera_format.update', $camera_format->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="name" value="{{ $camera_format->name }}" class="form-control">
                            </div>
                            <div class="col-md-2">
