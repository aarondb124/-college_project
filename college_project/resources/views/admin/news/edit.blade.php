            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class=""><i class="fab fa-servicestack me-1"></i>Edit News</div>
                    </div>
                    <div class="card-body table-card-body">
                        <form method="post" action="{{route('service.update',$service->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                <input type="date" id="date" class="form-control my-form-control @error('date') is-invalid @enderror" name="date" value="{{$service->date}}">
                                    @error('date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span> 
