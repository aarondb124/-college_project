...
public function index()
    {
        ...
        // return $service;
        return view('admin.news.index', compact('service'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.news.edit', compact('service'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $service->save();
        if ($service) {
            return redirect()->route('service.index')->with('success', 'News updated successfully');
        } else {
    ...
    public function destroy($id)
    {
        ...
        $service->delete();
        return redirect()->route('service.index')->with('success', 'news Deleted Successfully');
    }
}
